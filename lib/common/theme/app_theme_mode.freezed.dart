...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Light value)?  light,TResult Function( _Dark value)?  dark,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Light() when light != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Light value)  light,required TResult Function( _Dark value)  dark,}){
final _that = this;
switch (_that) {
case _Light():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Light value)?  light,TResult? Function( _Dark value)?  dark,}){
final _that = this;
switch (_that) {
case _Light() when light != null:
return light(_that);case _Dark() when dark != null:
...
class _Light implements AppThemeMode {
  const _Light();
...
class _Dark implements AppThemeMode {
  const _Dark();
